...
// As the name suggest it is something that needs to be called back that is afterwards later point of timeand not immediately
//In a Restraunt
...
//When we produce a promise, we create a new promise and send a result using that promise. When we consume a promise, we use callback functions for the fulfilled and rejected states of that promise.
